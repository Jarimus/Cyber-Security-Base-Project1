...
- [Flaw and fix location](./notes/views.py#L15)
...
- [Flaw and fix location](./notes/views.py#L60)
...
- [Flaw and fix location](./SecBaseProject/settings.py#L76)


### Flaw 4: Stored XSS
- User can write in a note's content scripts that can harm the system.
- CWE-80: Improper Neutralization of Script-Related HTML Tags in a Web Page (Basic XSS)
- [Flaw and fix location](./notes/templates/notes/detail.html#L8)
...
- Leave debug on
- [Flaw and fix location](./SecBaseProject/settings.py#L20)